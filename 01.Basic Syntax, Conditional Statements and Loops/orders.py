...
# Thus, you want to know the price of each order. On the first line, you will receive integer N – the number of orders
# the shop will receive. For each order, you will receive the following information:
...
numbre = int(input())
total = 0
for x in range(numbre):
    price = float(input())
    days = int(input())
    count = int(input())
    price_for_coffee = price * days * count
    print(f"The price for the coffee is: ${price_for_coffee:.02f}")
